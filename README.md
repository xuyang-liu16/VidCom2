...
* **`2026.01.22`** ✅✅ Integrated representative baselines: [DyCoke](https://github.com/KD-TAO/DyCoke), [FastVID](https://github.com/LunarShen/FastVID), [VisionZip](https://github.com/JIA-Lab-research/VisionZip), and [HoliTom](https://github.com/cokeshao/HoliTom) into our codebase ([`qwen`](https://github.com/xuyang-liu16/VidCom2/tree/qwen) branch) with **Qwen2-VL**, **Qwen2.5-VL**, and **Qwen3-VL** support. **More comparison results** are frequently updated on this [**`page`**](https://xuyang-liu16.github.io/VidCom2/).
