...
def vidcom2_compression(flattened_image_feature,model,base_scale,frame_score_mode,frame_token_lenth):
    ...
    if model == "llava_ov":
        ...
        token_per_frame = frame_token_lenth
    else :
    ...
    if model == "llava_ov":
        ...
        keep_index=get_keep_indices_of_llava_vid(sorted_indices,resize_h=13)
        converted_image_feature=flattened_image_feature[keep_index]
    elif model == "qwen2_vl":
        keep_index=get_keep_indices_of_qwen2_vl(sorted_indices,token_per_frame)
        converted_image_feature=flattened_image_feature[keep_index]
    else:
...
class Qwen2VisionTransformerPretrainedModel(Qwen2VLPreTrainedModel):
    ...
    def forward(self, hidden_states: torch.Tensor, grid_thw: torch.Tensor) -> torch.Tensor:
        ...
        keep_index=vidcom2_compression(merged_hidden_states,model,base_scale,frame_score_mode,frame_token_lenth)
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            if pixel_values_videos is not None:
                ...
                # video_mask = (
                #     (new_input_ids == self.config.video_token_id)
                #     .unsqueeze(-1)
                #     .expand_as(new_inputs_embeds)
